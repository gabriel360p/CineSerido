    ...
    <section class="latest-podcast-section section-padding pb-0" id="section_2">
        <div class="container">
                ...
                <div class="col-lg-10 col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 col-12">
                            ...
                            <div class="custom-block-info">
                                <div class="custom-block-top d-flex mb-1">
                                    <a href="http://localhost:8000/assentos/2" style="background-color: #B5121B" class="btn btn-danger">
                                        20/11
                                        <br>
                                        14:30
                                    </a>
            ...
            <div class="row justify-content-center mt-4">
                ...
                <div class="col-lg-4 col-12">
                    <!-- <form method="post" action="combos.php"> -->
                        <div class="mb-3 d-flex flex-column">
                            <div>
                                <label  style="color:white;" class="form-label ">Escolha o Assento</label>
                            </div>
                            <div class="d-flex flex-row">
                                ...
                                <div class="d-flex">
                                    <a  style="background-color: #B5121B; border:none; border-radius:10px; color:white; margin-left:5px;" class="btn" href="combos.php"><i class="fa-solid fa-arrow-right" style="color: #ffffff;" aria-hidden="true"></i></a>
                                </div>
