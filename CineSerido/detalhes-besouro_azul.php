                            ...
                            <div class="col-lg-3 col-12">
                                <div class="custom-block-icon-wrap">
                                    <div class="custom-block-image-wrap custom-block-image-detail-page">
                                        <img src="http://localhost:8000/images/movies/besouro_azul_poster.jpg" class="img-fluid" alt="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9 col-12">
                                <div class="custom-block-info">
                                    <div class="custom-block-top d-flex mb-1">
                                        ...
                                        <small class="ms-auto">Classificação indicativa <span class="badge bg-success">14</span></small>
                                    </div>

                                    <h2 class="mb-2" style="color: red;">Besouro Azul</h2>
